...
########################## training the classifier using both original and interpolated data using the source domains: "art_painting cartoon photo" domains
source_domains="012"
test_env=3
...
########################## training the classifier using both original and interpolated data using the source domains: "art_painting cartoon sketch" domains
source_domains="013"
test_env=2
gen_data_dir="save/dm/${dataset}/${source_domains}/generation"
...
########################## training the classifier using both original and interpolated data using the source domains: "art_painting photo sketch" domains
source_domains="023"
test_env=1
gen_data_dir="save/dm/${dataset}/${source_domains}/generation"
...
########################## training the classifier using both original and interpolated data using the source domains: "cartoon photo sketch" domains
source_domains="123"
test_env=0
gen_data_dir="save/dm/${dataset}/${source_domains}/generation"
